...
const messageBox = ({ title, answer, situation, btn1, btn2, time, date, count }) => {
    ...
    return (
        <div className="w-full shadow-[0px_0.5px_1.5px_0.75px_#00000026] p-[16px_12px_10px] rounded-lg mb-4">
            <div className="flex justify-between">
                <div className="flex justify-start items-center gap-x-3">
                    <div className="w-10 h-10 bg-[#ECECEC] rounded-full flex justify-center items-center">
                        <img src="/images/svg/tabbar/ticket.svg" alt="" className="" />
                    </div>
                ...
                {answer
                    ? (
                        <div className="w-6 h-6 bg-[#2C8C03] rounded-full shrink-0 flex justify-center font-bold text-[13px] leading-3 items-center text-white font-Anjoman">{count.toLocaleString("fa-IR")}</div>
                    ) : null}
            </div>
            ...
            <div className="flex justify-between child:rounded">
                ...
                <div className="bg-[#2B39A114] text-[#2B39A1] flex gap-x-[6px] justify-center items-center font-medium text-[10px] leading-4 p-[4px_14px_4px_14px]">
